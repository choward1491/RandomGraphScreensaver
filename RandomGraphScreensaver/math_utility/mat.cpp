...
namespace aSDG {
    namespace math {
        template<> double mat<0,0,double>::determinant() const {
            return 0.0;
        }
        
        template<> float mat<0,0,float>::determinant() const {
            return 0.0;
        }
        
        template<> double mat<1,1,double>::determinant() const {
            return d[0];
        }
        
        template<> float mat<1,1,float>::determinant() const {
            return d[0];
        }
